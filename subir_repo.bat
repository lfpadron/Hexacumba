...
set "REPO_URL=https://github.com/lfpadron/Hexacumba.git"
...
echo.
echo ==========================================
echo  Hexacumba - publicar en GitHub
echo ==========================================
echo Repo: %REPO_URL%
echo.
echo 1. Subir codigo
...
set "COMMIT_MSG="
set /p "COMMIT_MSG=Mensaje de commit [Actualiza Hexacumba]: "
if not defined COMMIT_MSG set "COMMIT_MSG=Actualiza Hexacumba"
...
(
    echo Hexacumba - git diff preparado para commit
    echo Fecha: !STAMP!
    echo Repo: %REPO_URL%
    echo.
    echo ===== git status --short =====
